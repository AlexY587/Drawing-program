...
int invisible=color(100, 100, 100, 0), Tint=color(80, 80, 80, 147.0f), playTint, pauseTint, forwardTint, backwardTint, nextTint, backTint, loopTint;
//
//Size changer
...
PFont titlefont;
int Variable, red=0xffFF0303, blue=0xff0503FF, reset=0xffFFFFFF, green=0xff36FF00, black=0xff000000, grey=0xffAFAFAF, fabricTint;
int redTint=0xffA50000, blueTint=0xff0011A5, greenTint=0xff00A52D, blackTint=0xff5D5D5D, selectorTint=0xffFFFFFF, shapeSelectorTint=0xffFFFFFF, squareTint=0xffFFFFFF, circleTint=0xffFFFFFF, lineTint=0xffFFFFFF;
int upTint, downTint, exitTint, closeTint, eraserTint, clearTint;
int radioTint;
...
public void setup() {
  ...
  colorchangeGreenX = appwidth/7.5f;
  ...
  shapePalletY = shapeSelectorY/1.1f;
  shapePalletWidth = palletWidth/1.2f;
  shapePalletHeight = palletHeight*2;
  squareStampX = colorchangeBlackX;
  squareStampY = shapeSelectorY*1.05f;
  squareStampWidth = colorchangeRedWidth;
  squareStampHeight = colorchangeRedHeight;
  circleStampX = colorchangeGreenX*1.1f;
  circleStampY = squareStampY*1.1f;
  ...
  sizeChangeY = appheight/2.8f;
  sizeChangeWidth = appwidth/12;
  sizeChangeHeight = appheight/11;
  sizeDisplayX = sizeChangeX*1.5f;
  sizeDisplayY = sizeChangeY*1.06f;
  sizeDisplayWidth = appwidth/40;
  sizeDisplayHeight = appheight/25;
  sizeUPXbridge = appwidth/11.7f;
  sizeUPYbridge = appheight/2.65f;
  sizeUPXleft = appwidth/10;
  sizeUPYleft = sizeDisplayY*1.05f;
  sizeUPXright = appwidth/14;
  sizeUPYright = sizeDisplayY*1.05f;
  sizeDOWNXbridge = sizeUPXbridge;
  sizeDOWNYbridge = appheight/2.35f;
  sizeDOWNXleft = sizeUPXleft;
  sizeDOWNYleft = sizeDisplayY*1.07f;
  sizeDOWNXright = sizeUPXright;
  sizeDOWNYright = sizeDisplayY*1.07f;
  upButtonX = sizeUPXbridge*0.83f;
  upButtonY = sizeUPYbridge*1;
  upButtonWidth = sizeUPXright/2.4f;
  upButtonHeight = sizeUPYbridge/18;
  downButtonX = sizeUPXright;
  downButtonY = sizeDOWNYbridge/1.05f;
  downButtonWidth = sizeUPXright/2.4f;
  downButtonHeight = sizeUPYbridge/18; 
  radioX = colorSelectorX;
  radioY = appheight/1.8f;
  radioWidth = appwidth/24;
  radioHeight = appheight/18;
  radioMenuX = appwidth/12;
  radioMenuY = appheight/1.95f;
  radioMenuWidth = appwidth/6.5f;
...
//end main program
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Drawing_program" };
    if (passedArgs != null) {
